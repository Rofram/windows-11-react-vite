...
`,M=o.span`
  ...
  `}
`;class X{constructor(){i(this,"time",new Date);m(this),setInterval(()=>this.tick(),1e3)}tick(){this.time=new Date}getHours(){const[s,r]=new Intl.DateTimeFormat("pt-br",{dateStyle:"short",timeStyle:"medium"}).format(this.time).split(" ");return[s,r]}}var G=new X;const t=k.exports.jsx,n=k.exports.jsxs,v=k.exports.Fragment;function K(){return t(f,{children:()=>{const[e,s]=G.getHours();return n(Y,{children:[t(M,{children:s}),t(M,{children:e})]})}})}const V=o.div`
  display: flex;
  gap: 4px;
  align-items: center;
`,u=o.img`
...
`,me=I(()=>n(ie,{children:[n(re,{children:[t(ae,{children:t("input",{type:"text",placeholder:"Type here to search"})}),n(le,{children:[t("span",{children:"Pinned"}),t(A,{onClick:()=>l.toggleAllApps(),children:l.isAllAppsOpened?n(v,{children:[t("span",{children:"<"}),t("span",{children:"Back"})]}):n(v,{children:[t("span",{children:"All apps"}),t("span",{children:">"})]})})]}),l.isAllAppsOpened?t(de,{children:l.apps.map(e=>n(w,{children:[t("img",{src:e.icon,alt:e.alt}),t(O,{children:e.alt})]},e.icon))}):t(ce,{children:l.apps.map(e=>n(w,{children:[t("img",{src:e.icon,alt:e.alt}),t(O,{children:e.alt})]},e.icon))}),!l.isAllAppsOpened&&n(v,{children:[n(ge,{children:[t("h2",{children:"Recommended"}),n(A,{children:[t("span",{children:"More"}),t("span",{children:">"})]})]}),t(pe,{children:l.recommendedApps.map(e=>n(he,{children:[t("img",{src:e.icon,alt:e.title}),n("div",{children:[t("span",{children:e.title}),t("p",{children:e.description})]})]},e.title))})]})]}),!l.isAllAppsOpened&&t(fe,{children:n(ue,{children:[t("img",{src:l.user.img,alt:""}),t("span",{children:l.user.name})]})})]})),xe=o.div`
  ${({theme:e})=>d`
    resize: both;
    width: 1100px;
    height: 618.75px;
...
`,Ee=o.span`
  ...
  font-size: 12px;
  color: white;
`;function Fe(){const[e]=h.exports.useState(Oe);return t(f,{children:()=>n(Ae,{ref:s=>e.setContainerRef(s),children:[n(Se,{onMouseDown:e.onMouseDown.bind(e),onMouseUp:e.onMouseUp.bind(e),onMouseMove:e.onMouseMove.bind(e),onMouseLeave:e.onMouseLeave.bind(e),children:[n("div",{children:[t(ze,{src:"assets/taskbar/vscode.png"}),t(Ee,{children:"VS Code"})]}),n("div",{children:[t(S,{size:20,color:"#fff"}),t(C,{size:15,color:"#fff"}),t(z,{size:20,color:"#fff",onClick:()=>l.setAppsOpened({vscode:!1})})]})]}),t(Ce,{children:t("iframe",{src:"https://www.vscode.dev"})})]})})}var Pe=h.exports.memo(Fe);const De=o.div`
  ...
  display: flex;
  position: relative;
`;function Ie(){return t(f,{children:()=>n(L,{theme:H,children:[t(W,{}),n(De,{children:[l.isStartMenuOpened&&t(me,{}),l.appsOpened.microsoftEdge&&t($e,{}),l.appsOpened.vscode&&t(Pe,{}),t(ne,{})]})]})})}U.render(t(j.StrictMode,{children:t(Ie,{})}),document.getElementById("root"));
